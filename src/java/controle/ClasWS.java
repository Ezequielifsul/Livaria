 ...
 * @author dappo
 */
@WebServlet(name = "ClasWS", urlPatterns = {"/admin/classificacao/ClasWS"})
public class ClasWS extends HttpServlet {
    private ClasDAO dao;
            ...
            case "list":
                ...
                if (request.getParameter("filtro") != null) {
                    try {
                        ...
                        Logger.getLogger(ClasWS.class.getName()).log(Level.SEVERE, null, ex);
                    }
                } else {
                    lista = dao.listar();
                }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            ...
            if(request.getParameter("txtClas") == null){
                ...
                if(request.getParameter("txtId")!= null){
                    ...
                    obj.setClas(request.getParameter("txtClas"));
